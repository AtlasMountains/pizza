...
if (isset($error) && $error) :?>
    ...
    <div class="container"><a href="afrekenen.php" class="btn btn-primary">Terug</a></div>
<?php endif; ?>
...
<div class="container mb-3 text-center">
    <div class="container-md"><h1>Overzicht bestellingen van</h1>
        <h2><small class="text-muted"><?= $gebruiker->getVoornaam() ?> <?= $gebruiker->getAchternaam() ?></small></h2>
    </div>
